...
function ProductDetail() {
  const { setShowProductDetail, product } = React.useContext(ShopiStorage);
  console.log(product);
  return(
    <>
      ...
      <div className="absolute bottom-0 w-full p-4 text-center">
        <button className="bg-emerald-600 font-semibold px-20 text-white py-2 rounded"> Add to Cart </button>
      </div>
    </>
  )
}
